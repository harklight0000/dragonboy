...
public final class GameCanvas extends ScaledInputCanvas implements nro.IActionListener {
    ...
    public final void keyPressed(int var1) {
        ...
        // Luôn nhận mã ae để dùng Skill hoặc Chat
        if (var1 >= 48 && var1 <= 57 || var1 >= 65 && var1 <= 122
                || var1 == 10 || var1 == 8 || var1 == 13 || var1 == 32 || var1 == 31) {
            ae = var1;
        }

        boolean isPc = mScreen.isPcEmulator();  // ← Hàm static trong mScreen
        ...
        if (currentDialog != null) {
            ...
            switch (var1) {
                ...
                // Phím số: Chỉ di chuyển trên điện thoại thật
                case 49: // 1
                ...
                case 55: // 7 - ← FIX: Thêm điều kiện screen
                    if (!isPc && (currentScreen == CrackBallScr.a
                            || (currentScreen == GameScreen.c && c && !ChatTextField.gI().isShow))) {
                        j[7] = true;
                        keyPressed[7] = true;
                ...
                case 57: // 9 - ← FIX: Thêm điều kiện screen
                    if (!isPc && (currentScreen == CrackBallScr.a
                            || (currentScreen == GameScreen.c && c && !ChatTextField.gI().isShow))) {
                        j[9] = true;
                        keyPressed[9] = true;
    ...
    public final void keyReleased(int var1) {
        ...
        switch (var1) {
            ...
            // Phím số: Chỉ reset j[] nếu không phải PC
            case 49: // 1
            case 50: // 2
            case 51: // 3
            case 52: // 4
            ...
            case 57: // 9
                if (!isPc) {
                    int index = var1 - 48;  // ← Tính toán chính xác
