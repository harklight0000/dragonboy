...
public final class GameCanvas extends ScaledInputCanvas implements nro.IActionListener {
   ...
   public final void keyPressed(int var1) {
      ...
      if (currentDialog != null) {
         ...
         case 48:
            ...
            return;
         case 49:
            if (currentScreen == CrackBallScr.a || currentScreen == GameScreen.c && c && !ChatTextField.gI().isShow) {
               j[1] = true;
               keyPressed[1] = true;
            }
   ...
   public final void keyReleased(int var1) {
      ...
      case 48:
         ...
         return;
      case 49:
         if (currentScreen == GameScreen.c && c && !ChatTextField.gI().isShow) {
            j[1] = false;
            an[1] = true;
         }
