...
public abstract class Yardart extends Boss {
    ...
    protected int getRangeCanAttackWithSkillSelect() {
        return switch (this.playerSkill.skillSelect.template.id) {
            case Skill.DRAGON, Skill.DEMON, Skill.GALICK, Skill.LIEN_HOAN, Skill.KAIOKEN -> 50;
            case Skill.KAMEJOKO, Skill.MASENKO, Skill.ANTOMIC -> 300;
            case Skill.DICH_CHUYEN_TUC_THOI -> 400;
            default -> 300;
        };
    }
