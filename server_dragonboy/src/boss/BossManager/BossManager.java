    ...
    public Boss createBoss(int bossID) {
        try {
            return switch (bossID) {
                ...
                case BossID.BROLY_BASE -> new BrolyBase();
                case BossID.CHILLED -> new Chilled();
                default -> null;
            };
        } catch (Exception e) {
