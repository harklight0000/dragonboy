...
public class Item {
    ...
    public ItemOption getOptionDaPhaLe() {
        return switch (template.id) {
            case 20 -> new ItemOption(77, 5);
            case 19 -> new ItemOption(103, 5);
            case 18 -> new ItemOption(80, 5);
            case 17 -> new ItemOption(81, 5);
            case 16 -> new ItemOption(50, 3);
            case 15 -> new ItemOption(94, 2);
            case 14 -> new ItemOption(108, 2);

            case 441 -> new ItemOption(95, 5);
            case 442 -> new ItemOption(96, 5);
            case 443 -> new ItemOption(97, 5);
            case 444 -> new ItemOption(98, 5);
            case 445 -> new ItemOption(99, 5);
            case 446 -> new ItemOption(100, 5);
            case 447 -> new ItemOption(101, 5);

            case 1416 -> new ItemOption(95, 5);
            case 1417 -> new ItemOption(96, 5);
            case 1418 -> new ItemOption(97, 5);
            case 1419 -> new ItemOption(98, 5);
            case 1420 -> new ItemOption(99, 5);
            case 1421 -> new ItemOption(100, 5);
            case 1422 -> new ItemOption(101, 5);

            case 1426 -> new ItemOption(95, 5);
            case 1427 -> new ItemOption(96, 5);
            case 1428 -> new ItemOption(97, 5);
            case 1429 -> new ItemOption(98, 5);
            case 1430 -> new ItemOption(99, 5);
            case 1431 -> new ItemOption(100, 5);
            case 1432 -> new ItemOption(101, 5);
            case 1433 -> new ItemOption(153, 5);
            case 1434 -> new ItemOption(160, 5);
            default -> itemOptions.get(0);
        };
    }
