...
//                        learnSkill(pl, item);
    ...
    private int randClothes(int level) {
        ...
        return GameData.LIST_ITEM_CLOTHES[Util.nextInt(0, 2)][Util.nextInt(0, 4)][result];
    }
    ...
    private void PhaoHoa(Player pl, Item item) {
        ...
        Service.gI().LogicEffect(pl, 1011, 1, -1, 1, 1, 15000);
    ...
    public void CapsuleKichHoat(Player player) {
        ...
        if (InventoryService.gI().getCountEmptyBag(player) >= emtyBag) {
            ...
            short itemId = GameData.TrangBiKichHoat[Util.nextInt(0, 4)][player.gender][0];
            Item ID_SetKichHoat = ItemService.gI().createNewItem(itemId);

            RewardService.gI().initChiSoItem(ID_SetKichHoat);
            ItemService.gI().Option(ID_SetKichHoat, ID_TrangBi);
