...
public class ConstNpc {
    ...
    public static final int MENU_HOC_KY_NANG = 12;
    public static final int MOC_NAP2 = 192972;
    public static final int MOC_NAP3 = 192972;
    
  
    public static final byte SU_PHU(Player pl){
       if(pl.zone.map.mapId == ConstMap.HANH_TINH_BILL)return WHIS;
       if(pl.zone.map.mapId == ConstMap.VACH_NUI_DEN)return VUA_VEGETA;
       if(pl.zone.map.mapId == ConstMap.DAO_KAME)return QUY_LAO_KAME;
       if(pl.zone.map.mapId == ConstMap.DAO_GURU)return TRUONG_LAO_GURU;
       return (byte) (13 + pl.gender);
    }
}
