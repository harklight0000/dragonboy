...
public class ConstSuperRank {
    ...
    public static final String TEXT_KHONG_TIM_THAY_NGUOI_CHOI = "Đối thủ đã bỏ chạy";
    public static final String TEXT_THIEU_1_NGOC = "Bạn không đủ ngọc, còn thiếu 1 ngọc nữa";
