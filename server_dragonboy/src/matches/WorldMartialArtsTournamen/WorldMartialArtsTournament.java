package matches.WorldMartialArtsTournamen;
    ...
    private void update() {
        if (timeUp < 23) {
            switch (timeUp) {
                ...
                case 9 -> Service.gI().chat(npc, "Xin quý vị khán giả cho 1 tràng pháo tay cổ vũ cho 2 đấu thủ nào");
                case 11 -> Service.gI().chat(npc, "Mọi người hãy ổn định chỗ ngồi, trận đấu sẽ bắt đầu sau 3 giây nữa");
                case 13 -> Service.gI().chat(npc, "3");
                case 15 -> Service.gI().chat(npc, "2");
                case 17 -> Service.gI().chat(npc, "1");
                case 19 -> Service.gI().chat(npc, "Trận đấu bắt đầu");
                case 22 -> {
                    try {
