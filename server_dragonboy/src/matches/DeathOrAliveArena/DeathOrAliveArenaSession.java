...
public class DeathOrAliveArenaSession {
    ...
    public void update() {
        ...
        if (timeWait > 0) {
            switch (timeWait) {
                ...
                case 3 -> Service.gI().chat(boss, "Sẵn sàng chưa?");
                case 1 -> {
                    ready();
    ...
    public void toTheNextRound() {
        try {
            ...
            Boss bss;
            switch (round) {
                case 0 -> bss = new Dracula(player);
                case 1 -> bss = new NguoiVoHinh(player);
                case 2 -> bss = new BongBang(player);
                case 3 -> bss = new VuaQuySaTang(player);
                case 4 -> bss = new ThoDauBac(player);
                case 5 -> {
                    champion();
                    return;
                }
