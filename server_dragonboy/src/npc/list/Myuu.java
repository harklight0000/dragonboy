...
public class Myuu extends Npc {
    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            if (this.mapId == 20) {
                createOtherMenu(player, ConstNpc.BASE_MENU, "Năm 740, ta tìm thấy kí sinh trùng của King Tuffle,\n" +
                ...
                createOtherMenu(player, ConstNpc.BASE_MENU, "Ngươi muốn về hả ?", "Quay Về", "Đóng");
            }
        }
    }
