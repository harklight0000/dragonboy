        ...
        if (canOpenNpc(player)) {
            if (this.mapId == 46) {
                ...
                if (player.idMark.isBaseMenu()) {
                    ...
                    if (select == 0) {
                        switch (player.levelLuyenTap) {
                            case 0 -> TrainingService.gI().callBoss(player, BossID.KARIN, false);
                            case 1 -> TrainingService.gI().callBoss(player, BossID.YAJIRO, false);
                            default -> TrainingService.gI().callBoss(player, BossID.KARIN, false);
                        }
                    }
                } else if (player.idMark.getIndexMenu() == 2003) {
                    if (select == 0) {
                        switch (player.levelLuyenTap) {
                            case 0 -> TrainingService.gI().callBoss(player, BossID.KARIN, true);
                            case 1 -> TrainingService.gI().callBoss(player, BossID.YAJIRO, true);
                            default -> TrainingService.gI().callBoss(player, BossID.YAJIRO, false);
                        }
                    }
                }
            }
