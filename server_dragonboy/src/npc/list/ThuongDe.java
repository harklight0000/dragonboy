            ...
            switch (mapId) {
                case 45 -> {
                    ...
                    switch (player.levelLuyenTap) {
                        case 2 -> this.createOtherMenu(player, ConstNpc.BASE_MENU,
                        ...
                        case 3 -> this.createOtherMenu(player, ConstNpc.BASE_MENU,
                ...
                case 141 -> this.createOtherMenu(player, 0,
                ...
                case 45 -> {
                    if (player.idMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 3 -> ChangeMapService.gI().changeMapBySpaceShip(player, 48, -1, 354);
                            case 4 -> this.createOtherMenu(player, ConstNpc.MENU_CHOOSE_LUCKY_ROUND,
                        ...
                        switch (select) {
                            ...
                            case 3 -> NpcService.gI().createMenuConMeo(player,
